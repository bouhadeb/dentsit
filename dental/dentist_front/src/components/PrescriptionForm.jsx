...
const PrescriptionForm = forwardRef(({ patientId }, ref) => {
  ...
  const addMedication = () => {
    if (prescription.medications.length >= 6) return;
      ...
      {!showPrescription ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="flex gap-4">
              <button 
                ...
                disabled={prescription.medications.length >= 6}
                className={`flex-1 py-4 px-6 btn btn-outline gap-2 ${prescription.medications.length >= 6 ? 'opacity-50 cursor-not-allowed' : ''}`}
              >
        ...
        >
          ...
          <input
            ...
            readOnly
            className="absolute top-[232px] left-[530px] w-[60px] bg-transparent border-none outline-none text-black font-semibold text-lg"
          />
          <DatePicker
            selected={date}
          ...
          <div>
            ...
            <div className="absolute top-[330px] left-[220px] w-[160px] h-[430px] text-black font-semibold">
              {prescription.medications.map((medication, index) => (
            ...
            <div className="absolute top-[330px] left-[390px] w-[125px] h-[430px] text-black font-semibold">
              {prescription.medications.map((medication, index) => (
                <div key={index} className="mb-10">
                  <input
                    type="text"
